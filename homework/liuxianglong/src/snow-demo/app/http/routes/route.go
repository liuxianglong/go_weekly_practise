 ...
 */
import (
	"snow-demo/app/http/controllers"
	"snow-demo/app/http/middlewares"
...
func RegisterRoute(router *gin.Engine) {
	...
	router.GET("/order_info", controllers.HandleGetOrderInfo)
	router.POST("/order", controllers.HandleOrder)
    //api版本
	v1 := router.Group("/v1")
	{
